...
from .const import DOMAIN, CONF_MAC_ADDRESS, CONF_DEVICE_NAME
...
class BabyCradleConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                title=user_input.get(CONF_DEVICE_NAME, "PT Baby Swing"),
                data={
                    CONF_MAC_ADDRESS: address,
                    CONF_DEVICE_NAME: user_input.get(CONF_DEVICE_NAME, "PT Baby Swing"),
                },
            )
